...
import { AuthGatePopup } from "@/components/checkout/AuthGatePopup";
            ...
            <div className="flex flex-col h-full overflow-hidden">
              ...
              <div className="p-6 border-t border-border bg-card-glow space-y-4">
                ...
                <Button 
                  ...
                  className="w-full rounded-none bg-primary text-primary-foreground font-space font-bold h-14 tracking-[0.3em] shadow-brutal hover:bg-white transition-all text-xs"
                >
                  PROCEED TO CHECKOUT
                </Button>
