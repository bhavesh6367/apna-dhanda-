    ...
    <div className="w-full relative z-1">
      ...
      >
        ...
        <div className="hidden md:block">
          <CarouselPrevious className="left-8 w-16 h-16 rounded-none bg-background/40 hover:bg-primary border-border text-white hover:text-primary-foreground backdrop-blur-md transition-all z-10 pointer-events-auto" />
          <CarouselNext className="right-8 w-16 h-16 rounded-none bg-background/40 hover:bg-primary border-border text-white hover:text-primary-foreground backdrop-blur-md transition-all z-10 pointer-events-auto" />
        </div>
      </Carousel>
    </div>
  );
